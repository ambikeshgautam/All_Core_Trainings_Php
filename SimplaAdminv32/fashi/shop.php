                ...
                <div class="col-lg-3 col-md-6 col-sm-8 order-2 order-lg-1 produts-sidebar-filter">                
                    <div class="filter-widget">
                        ...
                        <!-- fetching Categories -->
                         ...
                         <ul class="filter-catagories" id="filter_categories">
                            <li>
                               <a href="#" class="text_filter" id="<?= $row['category']?>"><?= $row['category']?></a>
                            </li>                                                      
                         </ul>
                         <?php } ?>
                             ...
                             <!-- Fetching Brand from product Table -->
                                <?php  
                                    ...
                                    <div class="fw-brand-check">                     
                                        <div class="bc-item">
                                            <label for-<? $row['brand']?>>                                               
                                                <input type="checkbox" class="common_selector product_check" id="brand" value="<?=$row['brand']?>">
                                                <?= $row['brand']?>
                    ...
                    <div class="filter-widget">
                        ...
                        <?php  
                           ...
                           while($row = $result->fetch_assoc()) { ?>
                        <div class="fw-tags">
                            <p id="<?=$row['tags'];?>" class="tag_filter" ><?=$row['tags'];?></p>                   
                        </div>
                     <? }?>
                     <!-- End fetching Tag   -->
                    </div>
