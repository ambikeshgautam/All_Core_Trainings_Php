           ...
           <div class="content-box">
                ...
                <div class="content-box-header">
                    ...
                    <ul class="content-box-tabs">
                        <li><a href="#tab1" class="default-tab">Brands</a></li>
                        <!-- href must be unique and match the id of target div -->
                        <li><a href="#tab2">Add Brand</a></li>
                    </ul>
                <div class="clear"></div>
            </div>
                              ...
                              <?php                              				
                                ...
                                <tr>
                                    ...
                                    <td>
                                		...
                                		<a href="brand_action.php?delete=<?= $row['id'] ?>"  onclick ="return confirm('Do you want to delete this category');"><img src="resources/images/icons/cross.png" alt="Delete"/></a>
                                		<a href="brand.php?edit=<?= $row['id'] ?>" ><img src="resources/images/icons/pencil.png" alt="Edit" name="edit" /></a>
	                        ...
	                        <form action="brand_action.php" method="POST">
	                        	<fieldset>
							         	  ...
							         	  <p>
							          	  ...
							          	  <p> 
							          	  		<label>Enter Description of Brand</label>
							                	<input type="text" name="detail" class="text-input small-input" value = "<?= $detail;?>" placeholder="Enter Description" require/>
							          	  </p>
							           	   <p>
                                            	 <?php if($update == true) { ?>
							              		 <input type="submit" name="update" class="button" value="Update Brand" require/>
							                	 <?php }else { ?>
							              		  <input type="submit" name="add" class="button" value="Add Brand" require/>
							               	     <?php } ?>
							               </p>
					              </fieldset>            
       					       </form>
