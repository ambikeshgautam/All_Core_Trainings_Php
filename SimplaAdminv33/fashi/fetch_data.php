...
if(isset($_POST['action'])){ //check whether action is comming or not in the field
        ...
        $sql = "SELECT * FROM add_products WHERE id !=''";//select all from add_products where brand is not Equal to NULL
        ...
        //--------------------------------Maximum No of product-----------------------------//
        if(isset($_POST['n_prd'])){ 	 
		    $load = (int)$_POST['n_prd'] + 9;		    
		    $sql .="LIMIT ".$load." ";		    
		}
