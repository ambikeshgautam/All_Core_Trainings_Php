            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-8 order-2 order-lg-1 produts-sidebar-filter">                
                    <div class="filter-widget">
                        ...
                        <!-- fetching Categories -->
                         ...
                         <ul class="filter-catagories" id="filter_categories">
                            <li>
                               <a href="javascript:void(0)" class="text_filter category" id="<?= $row['category']?>"><?= $row['category']?></a>
                            </li>                                                      
                         </ul>
                         <?php } ?>
                             ...
                             <!-- Fetching Brand from product Table -->
                                <?php while($row = $brand_result->fetch_assoc()) { ?>
                                    <div class="fw-brand-check">                     
                                        <div class="bc-item">
                                            <label for-<? $row['brand']?>>                                               
                                                <input type="checkbox" class="product_check brand" value="<?=$row['brand']?>">
                                                <?= $row['brand']?>
                    ...
                    <div class="filter-widget">
                        ...
                        <a href="javascript:void(0)" class="filter-btn" id="filter_button">Filter</a>
                    </div>
                    <!-- Color Fetching Here -->                    
                    <div class="filter-widget">
                        ...
                        <?php while($row = $color_result->fetch_assoc()) { ?>  
                          <div class="fw-color-choose">                             
                            <div class="cs-item">
                                <input type="radio" value="<?=$row['color'];?>" id="cs-<?=$row['color'];?>" class=" color_filter color">
                                <label class="cs-<?=$row['color'];?>" for="cs-<?=$row['color'];?>"><?=$row['color'];?></label>
                            </div>                           
                         </div>
                       <?php } ?>
                    </div>                   
                    ...
                    <div class="filter-widget">
                        ...
                        <div class="fw-tags">
                            <p id="<?=$row['tags'];?>" class="tag_filter tag" ><?=$row['tags'];?></p>                   
                        </div>
                     <? }?>
                     <!-- End fetching Tag   -->
                    </div>
