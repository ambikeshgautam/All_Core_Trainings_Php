            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-8 order-2 order-lg-1 produts-sidebar-filter">                
                    <div class="filter-widget">
                        ...
                        <!-- fetching Categories -->
                         ...
                         <ul class="filter-catagories" id="filter_categories">
                            <li>
                               <a href="#" class="product category" id="<?= $row['category']?>"><?= $row['category']?></a>
                            </li>                                                      
                         </ul>
                         <?php } ?>
                             ...
                             <!-- Fetching Brand from product Table -->
                                <?php while($row = $brand_result->fetch_assoc()) { ?>
                                    <div class="fw-brand-check">                     
                                        <div class="bc-item">
                                            <label for-<? $row['brand']?>>                                               
                                                <input type="checkbox" class="product_check brand " id="brand" value="<?=$row['brand']?>">
                                                <?= $row['brand']?>
                    ...
                    <div class="filter-widget">
                        ...
                        <div class="fw-tags">
                            <p id="<?=$row['tags'];?>" class="product tag" ><?=$row['tags'];?></p>                   
                        </div>
                     <? }?>
                     <!-- End fetching Tag   -->
                    </div>
