...
while ( $loop->have_posts() ) : $loop->the_post();
	...
	foreach ($filters as $filters_key => $filters_value) {
		...
		<div class="row text-center">
			<ul class="filtr-control-<?php echo $pf_gallery_id; ?> simplefilter simplefilter_<?php echo $pf_gallery_id; ?>">
				<?php 
				$all_category_val = $all_category[0]; ?>
				<li class="active filtr-controls-<?php echo $pf_gallery_id; ?>"  data-filter="all"><?php _e($all_category_val, 'portfolio-filter-gallery'); ?></li>
				<?php
