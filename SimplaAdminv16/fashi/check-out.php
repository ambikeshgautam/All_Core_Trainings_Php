                        ...
                        <div class="place-order">
                            ...
                            <div class="order-total">
                                <ul class="order-table">
                                    ...
                                    <li class="fw-normal"><?php echo $value['name']; ?> X <?php echo $value['quant']; ?> <span>$<?php echo $value['price'] * $value['quant'] ?></span></li>
                                    <?php } ?>
                                    <?php
                                    $sub_total = 0;
                                    ...
                                    <li class="fw-normal">Subtotal<span>$<?php echo $sub_total; ?></span></li>
