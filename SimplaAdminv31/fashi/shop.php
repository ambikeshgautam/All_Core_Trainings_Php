<?php
    ...
    $query = "SELECT DISTINCT category FROM add_products ORDER BY category"; 
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-8 order-2 order-lg-1 produts-sidebar-filter">                
                    <div class="filter-widget">
                        ...
                        <!-- fetching Categories -->
                         ...
                         <ul class="filter-catagories" id="filter_categories">
                            <li>
                               <a href="#" id="<?= $row['category']?>"><?= $row['category']?></a>
                            </li>                                                      
                         </ul>
                         <?php } ?>
                             ...
                             <!-- Fetching Brand from product Table -->
                                <?php  
                                    ...
                                    <div class="fw-brand-check">                     
                                        <div class="bc-item">
                                            <label for-<? $row['brand']?>>                                               
                                                <input type="checkbox" class="common_selector brand" value="<?=$row['brand']?>">
                                                <?= $row['brand']?>
                          ...
                          <div class="filter-range-wrap">
                            <div class="range-slider">
                                <div class="price-input">                               
                                    ...
                                    <input type="text" name="minmum" id="minamount">
                                    <input type="text" name="maximum" id="maxamount">
                                </div>
                            </div>
                    ...
                    <div class="filter-widget">
                        ...
                        <?php  
                           $query = "SELECT DISTINCT tags FROM add_products ORDER BY tags"; 
                           $stmt = $conn->prepare($query);
                           $stmt->execute();
                           $result = $stmt->get_result();  
                           while($row = $result->fetch_assoc()) { ?>
                        <div class="fw-tags">
                            <p id="<?=$row['tags'];?>"><?=$row['tags'];?></p>                   
                        </div>
                     <? }?>
                     <!-- End fetching Tag   -->
                    </div>
                            ...
                            <div class="col-lg-4 col-sm-6">
                                <div class="product-item">
                                    ...
                                    <div class="pi-text">
                                        ...
                                        <a href="product.php?details=<?echo $row['id'];?>">
                                            <h5><?echo $row['name']; ?></h5>
                                        </a>
