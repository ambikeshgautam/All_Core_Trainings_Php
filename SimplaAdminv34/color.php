	                        ...
	                        <form action="color_action.php" method="POST">
	                        	<fieldset>
							         	  ...
							         	  <p>
							           	   ...
							           	   <p>
							              		 <?php if($update == true) { ?>
							              		  <input type="submit" name="update" class="button" value="Update Color" require/>
							                	 <?php }else { ?>
							              		  <input type="submit" name="add" class="button" value="Add Color" require/>
							               	     <?php } ?>
							               </p>
					             </fieldset>            
                            </div>
